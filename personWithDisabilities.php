...
<!-- Add PWD -->
<div class="modal fade" id="pwdAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Person with Disabilities</h5>
            ...
            <form id="savePWD">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="PWD_ID" placeholder="PWD ID Number" aria-label="PWD_ID" aria-describedby="basic-addon1" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="TypeOfDisability" id="inputGroupSelect04">
                                <option selected>Choose...</option>
                                <option value="Visually Impaired">Visually Impaired</option>
                                <option value="Hearing Impaired">Hearing Impaired</option>
                                <option value="Orthopedically Disabled">Orthopedically Disabled</option>
                                ...
                                <option value="Attention Deficit Hyperactive Disorder">Attention Deficit Hyperactive Disorder</option>
                            </select>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="">Cause of Disability</label>
                        <input type="text" class="form-control" name="CauseOfDisability" autocomplete="off">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="PWDStatus" id="inputGroupSelect05">
                                <option selected>Choose...</option>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Save Person with Disability</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Edit PWD Modal -->
<div class="modal fade" id="pwdEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Person with Disability</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="updatePWD">
            <div class="modal-body">
                ...
                <input type="hidden" name="pwd_idNum" id="pwd_idNum" >

                <div class="mb-3">
                    <label for="">PWD ID Number</label>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">#</span>
                        <input type="text" class="form-control" name="PWD_ID" id="PWD_ID" placeholder="PWD ID Number" aria-label="PWD_ID" aria-describedby="basic-addon1" autocomplete="off">
                    </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="TypeOfDisability" id="inputGroupSelect09">
                                <option value="Visually Impaired">Visually Impaired</option>
                                <option value="Hearing Impaired">Hearing Impaired</option>
                                <option value="Orthopedically Disabled">Orthopedically Disabled</option>
                                <option value="Speech Impaired">Speech Impaired</option>
                    ...
                    <div class="mb-3">
                        <label for="">Cause of Disability</label>
                        <input type="text" class="form-control" name="CauseOfDisability" id="CauseOfDisability" autocomplete="off">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="PWDStatus" id="inputGroupSelect010">
                                <option value="Unknown">Unknown</option>
                                <option value="Active">Active</option>
                                <option value="Inactive">Inactive</option>
                                <option value="Deceased">Deceased</option>
                    ...
                    <div class="mb-3">
                        <label for="">Date Issued</label>
                        <div class="input-group date" id="datepicker1">
                            <input type="text" class="form-control" name="DateIssued" id="DateIssued" placeholder="mm/dd/yyyy" autocomplete="off">
                            <span class="input-group-append">
                                <span class="input-group-text bg-white d-block">
                                    <i class="fa fa-calendar"></i>
                                </span>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary">Update Person with Disability</button>
            </div>
        </form>
        </div>
    </div>
...
<!-- View PWD Modal -->
<div class="modal fade" id="pwdViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">View Person with Disability</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">PWD ID Number</label>
                    <p class="form-control" id="view_PWD_ID"></p>
                </div>
                <div class="mb-3">
                    <label for="">Barangay</label>
                ...
                <div class="mb-3">
                    <label for="">Type of Disability</label>
                    <p class="form-control" id="view_TypeOfDisability"></p>
                </div>
                <div class="mb-3">
                    <label for="">Cause of Disability</label>
                    <p class="form-control" id="view_CauseOfDisability"></p>
                </div>
                <div class="mb-3">
                    <label for="">PWD Status</label>
                    <p class="form-control" id="view_PWDStatus"></p>
                </div>
                <div class="mb-3">
                    <label for="">Date Issued</label>
...
<div class="container-fluid g-0">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" id="pwd-header">
                </div>
                <div class="card-header">
                    ...
                    <h4>
                    <span class="fw-normal fs-1 fw-normal text-uppercase">List of Person with Disabilities</span>
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#pwdAddModal">
                            Add Person with Disability
                        </button>
                    </h4>
                </div>
                <div class="card-body">

                    <table id="pwdTable" class="table table-bordered table-striped">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $pwd)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $pwd['DateOfBirth'] ?></td>
                                        <td><?= $pwd['Age'] ?></td>
                                        <td><?= $pwd['Sex'] ?></td>
                                        <td><?= $pwd['CivilStatus'] ?></td>
                                        <td><?= $pwd['TypeOfDisability'] ?></td>
                                        <td><?= $pwd['CauseOfDisability'] ?></td>
                                        <td><?= $pwd['pwdStatus'] ?></td>
                                        <td><?= $pwd['DateIssued'] ?></td>
                                        <td>
                                            <button type="button" value="<?=$pwd['ID'];?>" class="viewPWDBtn btn btn-info btn-sm">View</button>
                                            <button type="button" value="<?=$pwd['ID'];?>" class="editPWDBtn btn btn-success btn-sm">Edit</button>
                                            <button type="button" value="<?=$pwd['ID'];?>" class="deletePWDBtn btn btn-danger btn-sm">Delete</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
    ...
    <script>
        $(document).on('submit', '#savePWD', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("save_PWD", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 422) {
                        ...
                        $('#pwdAddModal').modal('hide');
                        $('#savePWD')[0].reset();

                        alertify.set('notifier','position', 'top-right');
                        alertify.success(res.message);

                        $('#pwdTable').load(location.href + " #pwdTable");
        ...
        $(document).on('click', '.editPWDBtn', function () {

            var pwd_id = $(this).val();
            
            $.ajax({
                type: "GET",
                url: "pwd-code.php?pwd_id=" + pwd_id,
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#pwd_idNum').val(res.data.ID);
                        $('#PWD_ID').val(res.data.ID_Number);
                        ...
                        $('#inputGroupSelect09').val(res.data.TypeOfDisability);
                        $('#CauseOfDisability').val(res.data.CauseOfDisability);
                        $('#inputGroupSelect010').val(res.data.pwdStatus);
                        $('#DateIssued').val(res.data.DateIssued);

                        $('#pwdEditModal').modal('show');
                    }
                }
            });
        });
        ...
        $(document).on('submit', '#updatePWD', function (e) {
            ...
            var formData = new FormData(this);
            formData.append("update_PWD", true);
        ...
        $(document).on('click', '.viewPWDBtn', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_PWD_ID').text(res.data.ID_Number);
                        ...
                        $('#view_TypeOfDisability').text(res.data.TypeOfDisability);
                        $('#view_CauseOfDisability').text(res.data.CauseOfDisability);
                        $('#view_PWDStatus').text(res.data.pwdStatus);
        ...
        $(document).on('click', '.deletePWDBtn', function (e) {
            e.preventDefault();
