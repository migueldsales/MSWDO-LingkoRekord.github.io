...
<body>
    ...
    <!-- Add KKC-KALIPI Modal -->
<div class="modal fade" id="kkc_kalipiAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add KKC-KALIPI Member</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="saveKKC_KALIPI">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="">With Identification Card</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect05">Options</label>
                            <select class="form-select" name="WithID" id="inputGroupSelect05">
                                <option selected>Choose...</option>
                    ...
                    <div class="mb-3">
                        <label for="">National - SAP Recipient</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect06">Options</label>
                            <select class="form-select" name="SAPNational" id="inputGroupSelect06">
                                <option selected>Choose...</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="mb-3">
                        <label for="">LGU - SAP Recipient</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect07">Options</label>
                            <select class="form-select" name="SAPLGU" id="inputGroupSelect07">
                                <option selected>Choose...</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="mb-3">
                        <label for="">Sustainable Livelihood Program Member</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect08">Options</label>
                            <select class="form-select" name="SLPMember" id="inputGroupSelect08">
                                <option selected>Choose...</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                    ...
                    <div class="mb-3">
                        <label for="">4P's Member</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect09">Options</label>
                            <select class="form-select" name="FourPSMember" id="inputGroupSelect09">
                                <option selected>Choose...</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Save KKC-KALIPI Member</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Edit KKC-KALIPI Modal -->
<div class="modal fade" id="kkc_kalipiEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit KKC-KALIPI Member</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form id="updateKKC_KALIPI">
            <div class="modal-body">

                <div id="errorMessageUpdate" class="alert alert-warning d-none"></div>

                <input type="hidden" name="kkc_kalipi_idNum" id="kkc_kalipi_idNum" >

                <div class="mb-3">
                        <label for="">Barangay</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect010">Options</label>
                            <select class="form-select" name="Barangay" id="inputGroupSelect010">
                                        <option selected>Choose...</option>
                                        <option value="Agoho">Agoho</option>
                                        <option value="Anahawan">Anahawan</option>
                                        <option value="Anas">Anas</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="Sex" id="inputGroupSelect011">
                                <option value="Male">Male</option>
                                <option value="Female">Female</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="CivilStatus" id="inputGroupSelect012">
                                <option value="Married">Married</option>
                                <option value="Single">Single</option>
                                <option value="Widowed">Widowed</option>
                                <option value="Seperated">Seperated</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">#</span>
                            <input type="text" class="form-control" name="NumOfDependents" id="NumOfDependents" placeholder="Number of Dependents" aria-label="NumOfDependents" aria-describedby="basic-addon1" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="EducationalAttainment" id="inputGroupSelect013">
                                <option value="No Grade Completed">No Grade Completed</option>
                                <option value="Elementary Undergraduate">Elementary Undergraduate</option>
                                <option value="Elementary Graduate">Elementary Graduate</option>
                                <option value="High School Undergraduate">High School Undergraduate</option>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="form-select" name="WithID" id="inputGroupSelect014">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="">National - SAP Recipient</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect015">Options</label>
                            <select class="form-select" name="SAPNational" id="inputGroupSelect015">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="">LGU - SAP Recipient</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect016">Options</label>
                            <select class="form-select" name="SAPLGU" id="inputGroupSelect016">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="">Sustainable Livelihood Program Member</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect017">Options</label>
                            <select class="form-select" name="SLPMember" id="inputGroupSelect017">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        <label for="">4P's Member</label>
                        <div class="input-group mb-3">
                            <label class="input-group-text" for="inputGroupSelect018">Options</label>
                            <select class="form-select" name="FourPSMember" id="inputGroupSelect018">
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-primary">Update KKC-KALIPI Member</button>
            </div>
        </form>
        </div>
    </div>
...
<!-- View KKC-KALIPI Modal -->
<div class="modal fade" id="kkc_kalipiViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">View KKC-KALIPI Member</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="">With Identification Card</label>
                    <p class="form-control" id="view_WithID"></p>
                </div>
                <div class="mb-3">
                    <label for="">National - SAP Recipient</label>
                    <p class="form-control" id="view_SAPNational"></p>
                </div>
                <div class="mb-3">
                    <label for="">LGU - SAP Recipient</label>
                    <p class="form-control" id="view_SAPLGU"></p>
                </div>
                <div class="mb-3">
                    <label for="">Sustainable Livelihood Program Member</label>
                    <p class="form-control" id="view_SLPMember"></p>
                </div>
                <div class="mb-3">
                    <label for="">4P's Member</label>
                    <p class="form-control" id="view_FourPSMember"></p>
                </div>
                <div class="mb-3">
                    <label for="">Status</label>
                    <p class="form-control" id="view_Status"></p>
                </div>
...
<div class="container-fluid g-0">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" id="kalipi-header">
                ...
                <div class="input-group rounded mb-3">
                    ...
                    <h4>
                    <span class="fs-3 fw-normal text-uppercase">List of KKC-Kalipi(Kababaihan Kabalikat ng Calauag-Kalipunan ng Liping Pilipina (KKC-KALIPI) Member </span>
                        <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#kkc_kalipiAddModal">
                            Add KKC-KALIPI Member
                        </button>
                    </h4>
                </div>
                <div class="card-body" id ="main-table">

                    <table id="kkc_kalipiTable" class="table table-bordered table-striped">
                        <thead class="table-primary">
                            <tr>
                                ...
                                <th>With Identification Card</th>
                                <th>National - SAP Recipient</th>
                                <th>LGU - SAP Recipient</th>
                                <th>Sustainable Livelihood Program Member</th>
                                <th>4P's Member</th>
                                <th>Status</th>
                                <th>Action</th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM kkc_kalipi_form";
                            $query_run = mysqli_query($connect, $query);

                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $kkc_kalipi)
                                {
                                    ?>
                                    <tr>
                                        <td><?= $kkc_kalipi['ID'] ?></td>
                                        <td><?= $kkc_kalipi['Barangay'] ?></td>
                                        <td><?= $kkc_kalipi['LastName'] ?></td>
                                        <td><?= $kkc_kalipi['FirstName'] ?></td>
                                        <td><?= $kkc_kalipi['MiddleName'] ?></td>
                                        <td><?= $kkc_kalipi['DateOfBirth'] ?></td>
                                        <td><?= $kkc_kalipi['Age'] ?></td>
                                        <td><?= $kkc_kalipi['Sex'] ?></td>
                                        <td><?= $kkc_kalipi['CivilStatus'] ?></td>
                                        <td><?= $kkc_kalipi['NumOfDependents'] ?></td>
                                        <td><?= $kkc_kalipi['EducationalAttainment'] ?></td>
                                        <td><?= $kkc_kalipi['Occupation'] ?></td>
                                        <td><?= $kkc_kalipi['SkillInterest'] ?></td>
                                        <td><?= $kkc_kalipi['WithID'] ?></td>
                                        <td><?= $kkc_kalipi['SAPNational'] ?></td>
                                        <td><?= $kkc_kalipi['SAPLGU'] ?></td>
                                        <td><?= $kkc_kalipi['SLP'] ?></td>
                                        <td><?= $kkc_kalipi['FourPS'] ?></td>
                                        <td><?= $kkc_kalipi['kkcStatus'] ?></td>
                                        <td>
                                            <button type="button" value="<?=$kkc_kalipi['ID'];?>" class="viewKKC_KALIPIBtn btn btn-info btn-sm">View</button>
                                            <button type="button" value="<?=$kkc_kalipi['ID'];?>" class="editKKC_KALIPIBtn btn btn-success btn-sm">Edit</button>
                                            <button type="button" value="<?=$kkc_kalipi['ID'];?>" class="deleteKKC_KALIPIBtn btn btn-danger btn-sm">Delete</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
    ...
    <script>
        $(document).on('submit', '#saveKKC_KALIPI', function (e) {
            e.preventDefault();
            var formData = new FormData(this);
            formData.append("save_KKC_KALIPI", true);

            $.ajax({
                type: "POST",
                url: "kkc-kalipi-code.php",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
                    ...
                    if(res.status == 422) {
                        ...
                        $('#kkc_kalipiAddModal').modal('hide');
                        $('#saveKKC_KALIPI')[0].reset();

                        alertify.set('notifier','position', 'top-right');
                        alertify.success(res.message);

                        $('#kkc_kalipiTable').load(location.href + " #kkc_kalipiTable");
                    }
        ...
        $(document).on('click', '.editKKC_KALIPIBtn', function () {

            var kkc_kalipi_id = $(this).val();
            
            $.ajax({
                type: "GET",
                url: "kkc-kalipi-code.php?kkc_kalipi_id=" + kkc_kalipi_id,
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#kkc_kalipi_idNum').val(res.data.ID);
                        $('#inputGroupSelect010').val(res.data.Barangay);
                        $('#LastName').val(res.data.LastName);
                        $('#FirstName').val(res.data.FirstName);
                        $('#MiddleName').val(res.data.MiddleName);
                        $('#txtbirthdate1').val(res.data.DateOfBirth);
                        $('#txtage1').val(res.data.Age);
                        $('#inputGroupSelect011').val(res.data.Sex);
                        $('#inputGroupSelect012').val(res.data.CivilStatus);
                        $('#NumOfDependents').val(res.data.NumOfDependents);
                        $('#inputGroupSelect013').val(res.data.EducationalAttainment);
                        $('#Occupation').val(res.data.Occupation);
                        $('#SkillInterest').val(res.data.SkillInterest);
                        $('#inputGroupSelect014').val(res.data.WithID);
                        $('#inputGroupSelect015').val(res.data.SAPNational);
                        $('#inputGroupSelect016').val(res.data.SAPLGU);
                        $('#inputGroupSelect017').val(res.data.SLP);
                        $('#inputGroupSelect018').val(res.data.FourPS);
                        $('#Status').val(res.data.kkcStatus);

                        $('#kkc_kalipiEditModal').modal('show');
                    }
                }
            });
        });

        $(document).on('submit', '#updateKKC_KALIPI', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("update_KKC_KALIPI", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 422) {
                        ...
                        $('#kkc_kalipiEditModal').modal('hide');
                        $('#updateKKC_KALIPI')[0].reset();
        ...
        $(document).on('click', '.viewKKC_KALIPIBtn', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_WithID').text(res.data.WithID);
                        $('#view_SAPNational').text(res.data.SAPNational);
                        $('#view_SAPLGU').text(res.data.SAPLGU);
                        $('#view_SLPMember').text(res.data.SLP);
                        $('#view_FourPSMember').text(res.data.FourPS);
                        $('#view_Status').text(res.data.kkcStatus);

                        $('#kkc_kalipiViewModal').modal('show');
                    }
                }
            });
        });

        $(document).on('click', '.deleteKKC_KALIPIBtn', function (e) {
            e.preventDefault();
            ...
            if(confirm('Are you sure you want to delete this data?'))
            {
                ...
                $.ajax({
                    ...
                    url: "kkc-kalipi-code.php",
                    data: {
                        'delete_KKC_KALIPI': true,
                        'kkc_kalipi_id': kkc_kalipi_id
                    },
                    success: function (response) {
