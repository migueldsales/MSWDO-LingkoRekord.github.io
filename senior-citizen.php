...
<head>
    ...
    <!-- Bootstrap CSS -->
    <style>
        <?php require 'senior-citizen.css' ?>
...
<body>
    ...
    <!-- add Senior Citizen Modal -->
    <div class="modal fade" id="seniorCitizenAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Senior Citizen</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <form id="saveSeniorCitizen">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="">Active/Inactive Status</label>
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="inputGroupSelect04">Options</label>
                                    <select class="form-select" name="SCStatus" id="inputGroupSelect04">
                                        <option selected>Choose...</option>
                            ...
                            <div class="mb-3">
                                <label for="">OSCA ID Number</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">#</span>
                                    <input type="text" class="form-control" name="OSCAIdNumber" placeholder="OSCA ID Number" aria-label="OSCAIDNumber" aria-describedby="basic-addon1" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group date" id="datepicker1">
                                    <input type="text" class="form-control" name="DateIssued" placeholder="mm/dd/yyyy" autocomplete="off">
                                    <span class="input-group-append">
                                        <span class="input-group-text bg-white d-block">
                                            <i class="fa fa-calendar"></i>
                                        </span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="Remark" id="inputGroupSelect05">
                                        <option selected>Choose...</option>
                                        <option value="Indigent">Indigent</option>
                                        <option value="Pension (SSS, GSIS)">Pension (SSS, GSIS)</option>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary">Save Senior Citizen</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <!-- edit Senior Citizen Modal -->
        <div class="modal fade" id="seniorCitizenEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Senior Citizen</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <form id="updateSeniorCitizen">
                        <div class="modal-body">

                            <div class="alert alert-warning d-none" id="errorMessageUpdate"></div>

                            <input type="hidden" name="seniorCitizen_id" id="seniorCitizen_id" >

                            <div class="mb-3">
                                <label for="">Barangay</label>
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="inputGroupSelect06">Options</label>
                                    <select class="form-select" name="Barangay" id="inputGroupSelect06">
                                        <option selected>Choose...</option>
                                        <option value="Agoho">Agoho</option>
                                        <option value="Anahawan">Anahawan</option>
                                        <option value="Anas">Anas</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">✎</span>
                                    <input type="text" class="form-control" placeholder="Last Name" name="LastName" id="LastName" aria-label="LastName" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="">First Name</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">✎</span>
                                    <input type="text" class="form-control" placeholder="First Name" name="FirstName" id="FirstName" aria-label="FirstName" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="">Middle Name</label>
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">✎</span>
                                    <input type="text" class="form-control" placeholder="Middle Name" name="MiddleName" id="MiddleName" aria-label="MiddleName" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="txtbirthdate">Birthday</label>
                                <div class="input-group date" id="datepicker">
                                    <input type="text" class="form-control" name="txtbirthdate" id="txtbirthdate1" placeholder="mm/dd/yyyy" onkeyup="getAgeVal1(0)" onblur="getAgeVal1(0);">
                                    <span class="input-group-append">
                                        <span class="input-group-text bg-white d-block">
                                            <i class="fa fa-calendar"></i>
                                        </span>
                            ...
                            <div class="mb-3">
                                <label for="">Age</label>
                                <input type="text" class="form-control" name="txtage" id="txtage1" autocomplete="off">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="Sex" id="inputGroupSelect07">
                                        <option value="Male">Male</option>
                                        <option value="Female">Female</option>
                                    </select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="CivilStatus" id="inputGroupSelect08" >
                                        <option value="Married">Married</option>
                                        <option value="Single">Single</option>
                                        <option value="Widowed">Widowed</option>
                                        <option value="Seperated">Seperated</option>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="SCStatus" id="inputGroupSelect09">
                                        <option value="Active">Active</option>
                                        <option value="Inactive">Inactive</option>
                                    </select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="basic-addon1">#</span>
                                    <input type="text" class="form-control" name="OSCAIdNumber" id="OSCAIdNumber" placeholder="OSCA ID Number" aria-label="OSCAIDNumber" aria-describedby="basic-addon1">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="">Date Issued</label>
                                <div class="input-group date" id="datepicker1">
                                    <input type="text" class="form-control" name="DateIssued" id="DateIssued" placeholder="mm/dd/yyyy">
                                    <span class="input-group-append">
                                        <span class="input-group-text bg-white d-block">
                                            <i class="fa fa-calendar"></i>
                                        </span>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select" name="Remark" id="inputGroupSelect010">
                                        <option value="Indigent">Indigent</option>
                                        <option value="Pension (SSS, GSIS)">Pension (SSS, GSIS)</option>
                                        <option value="Family Support">Family Support</option>
                                        <option value="Social Pension">Social Pension</option>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-primary">Update Senior Citizen</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade" id="seniorCitizenViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">View Senior Citizen</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="txtbirthdate">Birthday</label>
                                <p class="form-control" id="view_Birthday"></p>
                            </div>
                            <div class="mb-3">
                                <label for="">Age</label>
                            ...
                            <div class="mb-3">
                                <label for="">Active/Inactive Status</label>
                                <p class="form-control" id="view_SCStatus"></p>
                            </div>
                            <div class="mb-3">
                                <label for="">OSCA ID Number</label>
                                <p class="form-control" id="view_OSCAIdNumber"></p>
                            </div>
                            <div class="mb-3">
                                <label for="">Date Issued</label>
                                <p class="form-control" id="view_DateIssued"></p>
                            </div>
                            <div class="mb-3">
                                <label for="">Remark</label>
                                <p class="form-control" id="view_Remark"></p>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        ...
        <div class="container-fluid g-0">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                    <div class="card-header text-center" id="senior-citizen-header">
                    </div>
                        <div class="card-header">
                            ...
                            <h4>
                            <span class="fw-normal fs-1 fw-normal text-uppercase">List of Senior Citizen</span>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#seniorCitizenAddModal">
                                Add Senior Citizen
                                </button>
                            </h4>
                        </div>
                        <div class="card-body">
                            <table id="scTable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        $query = "SELECT * FROM seniorcitizen_form";
                                        $query_run = mysqli_query($connect, $query);

                                        if(mysqli_num_rows($query_run) > 0) {
                                            foreach($query_run as $seniorCitizen)
                                            {
                                                ?>
                                                <tr>
                                                    <td><?= $seniorCitizen['ID'] ?></td>
                                                    <td><?= $seniorCitizen['barangay'] ?></td>
                                                    <td><?= $seniorCitizen['lastName'] ?></td>
                                                    <td><?= $seniorCitizen['firstName'] ?></td>
                                                    <td><?= $seniorCitizen['middleName'] ?></td>
                                                    <td><?= $seniorCitizen['birthDay'] ?></td>
                                                    <td><?= $seniorCitizen['age'] ?></td>
                                                    <td><?= $seniorCitizen['sex'] ?></td>
                                                    <td><?= $seniorCitizen['civilStatus'] ?></td>
                                                    <td><?= $seniorCitizen['scStatus'] ?></td>
                                                    <td><?= $seniorCitizen['oscaIdNumber'] ?></td>
                                                    <td><?= $seniorCitizen['dateIssued'] ?></td>
                                                    <td><?= $seniorCitizen['remark'] ?></td>
                                                                                                        <td>
                                                        <button type="button" value="<?=$seniorCitizen['ID'];?>" class="viewSeniorCitizenBtn btn btn-info btn-sm mb-2">View</button>
                                                        <button type="button" value="<?=$seniorCitizen['ID'];?>" class="editSeniorCitizenBtn btn btn-success btn-sm mb-2">Edit</button>
                                                        <button type="button" value="<?=$seniorCitizen['ID'];?>" class="deleteSeniorCitizenBtn btn btn-danger btn-sm mb-2">Delete</button>
                                                    </td>
    ...
    <script>
        $(document).on('submit', '#saveSeniorCitizen', function (e) {
            e.preventDefault();
            var formData = new FormData(this);
            formData.append("save_SeniorCitizen", true);

            $.ajax({
                type: "POST",
                url: "senior-citizen-code.php",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
                    ...
                    if(res.status == 422) {
                        ...
                        $('#seniorCitizenAddModal').modal('hide');
                        $('#saveSeniorCitizen')[0].reset();

                        alertify.set('notifier','position', 'top-right');
                        alertify.success(res.message);

                        $('#scTable').load(location.href + " #scTable");
                    }
        ...
        $(document).on('click', '.editSeniorCitizenBtn', function (e) {

            var seniorCitizen_id = $(this).val();

            $.ajax({
                type: "GET",
                url: "senior-citizen-code.php?seniorCitizen_id=" + seniorCitizen_id,
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#seniorCitizen_id').val(res.data.ID);
                        $('#inputGroupSelect06').val(res.data.barangay);
                        $('#LastName').val(res.data.lastName);
                        $('#FirstName').val(res.data.firstName);
                        $('#MiddleName').val(res.data.middleName);
                        $('#txtbirthdate1').val(res.data.birthDay);
                        $('#txtage1').val(res.data.age);
                        $('#inputGroupSelect07').val(res.data.sex);
                        $('#inputGroupSelect08').val(res.data.civilStatus);
                        $('#inputGroupSelect09').val(res.data.scStatus);
                        $('#OSCAIdNumber').val(res.data.oscaIdNumber);
                        $('#DateIssued').val(res.data.dateIssued);
                        $('#inputGroupSelect010').val(res.data.remark);

                        $('#seniorCitizenEditModal').modal('show');
                    }
                }
            });
        });

        $(document).on('submit', '#updateSeniorCitizen', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("update_SeniorCitizen", true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 422) {
                        ...
                        $('#seniorCitizenEditModal').modal('hide');
                        $('#updateSeniorCitizen')[0].reset();
        ...
        $(document).on('click', '.viewSeniorCitizenBtn', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 404) {
                        ...
                        $('#view_SCStatus').text(res.data.scStatus);
                        $('#view_OSCAIdNumber').text(res.data.oscaIdNumber);
                        $('#view_DateIssued').text(res.data.dateIssued);
                        $('#view_Remark').text(res.data.remark);

                        $('#seniorCitizenViewModal').modal('show');
                    }
                }
            });
        });

        $(document).on('click', '.deleteSeniorCitizenBtn', function (e) {
            e.preventDefault();
            ...
            if(confirm('Are you sure you want to delete this data?'))
            {
                ...
                $.ajax({
                    ...
                    url: "senior-citizen-code.php",
                    data: {
                        'delete_SeniorCitizen': true,
                        'seniorCitizen_id': seniorCitizen_id
                    },
                    success: function (response) {
